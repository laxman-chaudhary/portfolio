...
<div class="row">
        ...
        <div class="card gradient-1">
            <div class="card-body">
                ...
                <div class="d-inline-block">
                    <h2 class="text-white">{{ App\Models\Subscriber::count() }}</h2>
    ...
    <div class="col-lg-3 col-sm-6">
        <div class="card gradient-2">
            <div class="card-body">
                ...
                <div class="d-inline-block">
                    <h2 class="text-white">{{ App\Models\Skill::count() }}</h2>
    ...
    <div class="col-lg-3 col-sm-6">
        <div class="card gradient-3">
            <div class="card-body">
                ...
                <div class="d-inline-block">
                    <h2 class="text-white">{{ App\Models\Testimonial::count() }}</h2>
    ...
    @php
    $siteInfo=App\Models\Setting::first();
    @endphp
    <div class="col-md-6">
