...
<head>
    <meta charset="utf-8">
    <title>Laxman Chaudhary</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- CSRF Token -->
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <meta name="description" content="Laxman Chaudhary">
    <meta property="og:title" content="Laxman Chaudhary" />
    <meta property="og:description" content="Laxman Chaudhary" />
    <meta name="twitter:title" content="Laxman Chaudhary" />
    <meta name="twitter:description" content="Laxman Chaudhary" />
    <meta name="twitter:site" content="https://chaudharylaxman.com.np" />
        ...
        <div class="header-area">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-10">
                      @php
                      $hire=App\Models\Lang::where('key','hire_link')->select($settings->lang)->first();
                      $lang=$settings->lang;
                      @endphp
                        ...
                        <div>
                            <div class="hero-content text-center">
                                <div class="typing-head">
                                    @php
                                    $e=App\Models\Lang::where('key','i_am')->select($settings->lang)->first();
                                    $lang=$settings->lang;
                                    @endphp
                                    <h3>{{ $e->$lang }}</h3>
                                </div>
                                ...
                                <div class="hero-social-link">
                                 ...
                                 @foreach(App\Models\Social::latest()->get() as $social)   
                ...
                <div class="col-lg-4 valign">
                    <div class="content mb-50">
                        <div class="section-head text-left mb-30">
                            @php
                            $about=App\Models\Lang::where('key','about_me')->select($settings->lang)->first();
                            $lang=$settings->lang;
                            @endphp
                            <h1>{{ $about->$lang }}</h1>
                            <span class="span"></span>
                        </div>
                        <p>{{ App\Models\About::first()->description }}</p>
                        @php
                        $cv=App\Models\Lang::where('key','cv')->select($settings->lang)->first();
                        $lang=$settings->lang;
                        @endphp
                        <a href="{{ App\Models\About::first()->cv }}" class="btn mt-30">{{ $cv->$lang }}</a>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="about-hero-img">
                        <img data-tilt class="img-fluid lazy" src="{{ asset('uploads/loader.gif') }}"  data-src="{{ asset(App\Models\About::first()->image) }}" alt="{{ App\Models\About::first()->image }}" >
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="content mb-50">
                        <div class="skills-head-type">
                             @php
                            $skilltr=App\Models\Lang::where('key','skill')->select($settings->lang)->first();
                            $lang=$settings->lang;
                            @endphp
                            <h1>{{ $skilltr->$lang }}</h1>
                        </div>
    ...
    <div class="resume-area">
        <div class="resume-head-title text-center mb-40 pt-100">
            <div class="col-lg-6 mx-auto">
               @php
               $experince=App\Models\Lang::where('key','experince')->select($settings->lang)->first();
               $lang=$settings->lang;
               @endphp
        ...
        <div class="container">
            <div class="row">
                @foreach(App\Models\Exeperince::latest()->get() as $exeperince)
...
<section  id="service" class="pt-100">
    <div class="service-area">
        <div class="service-head-title text-center mb-40 pt-100">
            <div class="col-lg-6 mx-auto">
                 @php
               $service=App\Models\Lang::where('key','service')->select($settings->lang)->first();
               $lang=$settings->lang;
               @endphp
               <h1>{{ $service->$lang }}</h1>
...
<section id="portfolio">
    <div class="portfolio-area pt-100">
        <div class="portfolio-head-title text-center mb-40">
            <div class="col-lg-6 mx-auto">
               @php
               $my_work=App\Models\Lang::where('key','work')->select($settings->lang)->first();
               $lang=$settings->lang;
               @endphp
               <h1>{{ $my_work->$lang }}</h1>
           ...
           <div class="container">
               <div class="">
                ...
                <div class="row grid portfolio-item">
                    @foreach(App\Models\Portfolio::latest()->get() as $portfolio )
...
<section id="contact">
    <div class="contact-area pt-100">
        <div class="contact-head-title text-center mb-40">
            <div class="col-lg-6 mx-auto">
                 @php
               $my_contact=App\Models\Lang::where('key','contact')->select($settings->lang)->first();
               $lang=$settings->lang;
               @endphp
               ...
               <div class="col-lg-4">
                <div class="text-center">
                    <div class="single-contact-info">
                        ...
                        <div class="info mt-3">
                           @php
                           $phone=App\Models\Lang::where('key','phone')->select($settings->lang)->first();
                           $lang=$settings->lang;
                           @endphp
                           <h5>{{ $phone->$lang }}</h5>
            ...
            <div class="col-lg-4">
                <div class="text-center">
                    <div class="single-contact-info">
                        ...
                        <div class="info mt-3">
                           @php
                           $email=App\Models\Lang::where('key','email')->select($settings->lang)->first();
            ...
            <div class="col-lg-4">
                <div class="text-center">
                    <div class="single-contact-info">
                        ...
                        <div class="info mt-3">
                            @php
                           $address=App\Models\Lang::where('key','office')->select($settings->lang)->first();
                           $lang=$settings->lang;
                           @endphp
                           <h5>{{ $address->$lang }}</h5>
           ...
           <div class="col-lg-12">
            ...
            <div class="contact-form">
                <form action="{{ route('contact.store') }}" method="POST" id="contact">
                    ...
                    @php
                    $sendmsg=App\Models\Lang::where('key','sendmsg')->select($settings->lang)->first();
                    $lang=$settings->lang;
                    @endphp
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2 text-center">
                    ...
                    <div class="subscriber-content">
                       @php
                       $my_email=App\Models\Lang::where('key','subs_email')->select($settings->lang)->first();
                       $lang=$settings->lang;
                       @endphp
                       <h1>{{ $my_email->$lang }}</h1>
                            ...
                            <div class="input-form">
                                <input type="text" name="email" id="subemail" placeholder="Enter your email here...">
                                    ...
                                    <div class="input-group-append">
                                        @php
                                        $subscibe=App\Models\Lang::where('key','subscibe')->select($settings->lang)->first();
                                        $lang=$settings->lang;
                                        @endphp
